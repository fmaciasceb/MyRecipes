...
namespace My1stRecipe
{
    class Shadows
    {
        ...
        public void ApplyShadows(Panel OB, Panel  Contenedor)
        {
            ...
            T.BackgroundImage = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..T_WHITE;
            L.BackgroundImage = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..L_WHITE;
            R.BackgroundImage = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..R_WHITE; 
            B.BackgroundImage = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..B_WHITE;
            TL.Image = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..TL_WHITE; 
            TR.Image = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..TR_WHITE; 
            BL.Image = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..BL_WHITE; 
            BR.Image = _MaciasCeballos.Fernando_._MyRecipes_._MaciasCeballos.Fernando_._MyRecipes_.Resources..BR_WHITE; 
